...
public class Bootstrap {
    ...
    private static final int PORT = System.getenv("OPENSHIFT_DIY_IP") != null ? Integer.parseInt(System.getenv("OPENSHIFT_DIY_IP")) : 8082;
    ...
    public static void main(String[] args) throws Exception {
        ...
        new TodoResources(new TodoServices(mongo()));
    }
    ...
    private static DB mongo() throws Exception {
        ...
        if (host == null) {
            ...
            return mongoClient.getDB("shipapp");
        }
